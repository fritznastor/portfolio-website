...
// The Navbar component is a functional component that renders a navigation bar with links to the Home, Projects, About, 
// and Contact sections of the portfolio page. The links use the react-scroll library to smoothly scroll to the corresponding 
